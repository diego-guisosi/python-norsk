...
class TestSequenceProtocol(unittest.TestCase):
    ...
    def test_protocol(self):
        # As a curiosity, test removing the Sequence decoration from SortedSet constructor
        # All of the tests will still pass, except this one. But this is a more advanced topic and it will be covered
        # afterwards
