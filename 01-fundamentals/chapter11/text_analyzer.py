...
def analyze_text(filename):
    ...
    Raises:
        IOError: If 'filename' does not exist or can not be read
...
class TextAnalysisTest(unittest.TestCase):
    ...
    def tearDown(self):
        """ Fixture that deletes the files used by the test method.s """
        try:
    ...
    def test_function_runs(self):
        """ Basic smoke test: does the function to run. """
